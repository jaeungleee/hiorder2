<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <Number label="NumberOfPeople" v-model="item.numberOfPeople" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="IsOrderable" v-model="item.isOrderable" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
