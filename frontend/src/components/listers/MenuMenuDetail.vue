<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <LongManager offline label="InventoryId" v-model="item.inventoryId" :editMode="false" @change="change" />
            <IntegerManager offline label="IngredientUnit" v-model="item.ingredientUnit" :editMode="false" @change="change" />
        </v-card-text>
