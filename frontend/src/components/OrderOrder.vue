<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            <Number label="NumberOfPeople" v-model="value.numberOfPeople" :editMode="editMode" :inputUI="''"/>
            ...
            <String label="IsOrderable" v-model="value.isOrderable" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
